...
public class RobotContainer 
{
  ...
  // A simple auto routine that drives forward for a specified amount of distance, and then stops.

  private final Command m_DriveForwardEncodersAuto = 
    new DriveForwardEncoders(60, Constants.AutoConstants.kAutoDriveSpeed, m_drivetrain);
    
  private final Command m_DriveBackwardsEncodersAuto =
    new DriveBackwardsEncoders(60, Constants.AutoConstants.kAutoDriveSpeed, m_drivetrain);

  private final Command m_DriveTimeAuto = 
    new DriveTime(300,-.2,m_drivetrain);
    ...
    new JoystickButton(driverController,4)
        .whileTrue(
            new PIDCommand(
                ...
                output -> m_drivetrain.arcadeDrive(-driverController.getY(), output),
